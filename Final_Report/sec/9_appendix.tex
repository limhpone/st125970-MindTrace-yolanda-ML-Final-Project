...
Figure~\ref{fig:ui_overview} shows the default Predict tab and an Anger prediction at 98.0\% confidence. The preprocessing trace demonstrates retention of the negation word ``never'' during stopword removal. Figure~\ref{fig:ui_love}(a,\,b) shows Love (83.3\%) and Sadness (98.9\%) predictions; the Love example illustrates the Joy$\leftrightarrow$Love overlap, with Joy as runner-up at 16.4\%.
