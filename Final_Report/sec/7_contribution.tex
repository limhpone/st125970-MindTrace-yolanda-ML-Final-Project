...
\begin{table}[!htb]
\centering
\caption{Part~A results --- SVM test-set performance when each preprocessing step is removed. $\Delta$\,Acc and $\Delta$\,F1 are relative to the full-pipeline baseline.}
