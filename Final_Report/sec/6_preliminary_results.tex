...
\begin{enumerate}[nosep]
    \item \textbf{Valence conflation (Joy $\leftrightarrow$ Love).} All models showed notable Joy$\leftrightarrow$Love misclassification (see Figure~\ref{fig:confusion_matrices}), reflecting shared positively-valenced vocabulary (``happy'', ``amazing'').
