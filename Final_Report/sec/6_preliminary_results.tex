...
The consistently high performance across all four models (90.79--93.93\% accuracy) can be attributed to three factors:
(1)~\textbf{effective class balancing} --- downsampling to 14,972 samples per class eliminated the 9.5:1 imbalance ratio, with macro-F1 closely tracking accuracy ($\leq$0.07\,pp gap);
